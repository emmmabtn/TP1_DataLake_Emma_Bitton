...
class DataLakeServiceSamples(object):
    ...
    connection_string = os.environ["DefaultEndpointsProtocol=https;AccountName=csb10037ffead93967e;AccountKey=yovLaaxpqmQndNspKOc8lSVgqroADR34oR9QNWHg4YJDD+fgqqh6YtHqSQ6DzgpmA/inNqnCXmGF+ASt3zcLbA==;EndpointSuffix=core.windows.net"]
    account_name = os.getenv('csb10037ffead93967e', "")
    
    active_directory_application_id = os.getenv("4e77896055c54b18bf2df04e85a6bde9")
    active_directory_application_secret = os.getenv("ACTIVE_DIRECTORY_APPLICATION_SECRET")
    active_directory_tenant_id = os.getenv("413600cf-bd4e-4c7c-8a61-69e73cddf731")
